      ...
      <div className="px-6 py-4 common-border3 rounded-3xl bg-indigo-900/40">
        <div className="flex flex-col gap-4 lg:flex-row items-center  justify-between border-b pb-4">
          ...
          <div className="flex gap-4 text-white">
            <Link href={"https://www.linkedin.com/company/infinitydevshq/"} target="_blank" className="common-gradient p-4 rounded-full">
              <Linkedin size={32} fill="transparent" />
            </Link>
            <Link href={"https://twitter.com/InfinityDevsHQ"} target="_blank" className="common-gradient p-4 rounded-full">
              <Twitter size={32} fill="transparent" />
            </Link>
            <Link href={"https://www.instagram.com/infinitydevshq"} target="_blank" className="common-gradient p-4 rounded-full">
