...
export default function WhoWeAre() {
  return (
    <section className="flex items-center justify-center bg-slate-900  px-8 py-4">
      <div className="box-max-width">
        ...
        <p className="main-descriptions text-center">
          ...
          designed and marketed by professionals who are wizards when it comes
          to turing users into raving fanatics and generating consistent leads
          for your business.
        </p>
        <p className="main-descriptions text-center">
          ...
          work overseas or to robots. We are real people, with a real passion
          for what we do.
        </p>
      </div>
    </section>
