...
export default function HowWeWork() {
  return (
    <section className="px-8 py-4 work-bg flex flex-col gap-10">
      ...
      <div className="flex items-center justify-center w-full uppercase text-base sm:text-xl font-bold text-zinc-300 pt-10">
