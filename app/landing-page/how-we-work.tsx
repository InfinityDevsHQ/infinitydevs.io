...
export default function HowWeWork() {
  return (
    <section className='px-3 py-4 md:px-8 md:py-6 work-bg flex flex-col gap-7 md:gap-20'>
      ...
      <div className='flex items-center justify-center w-full uppercase text-base sm:text-xl font-bold text-zinc-300 pt-10 md:pt-28'>
        <div className='hidden md:grid grid-cols-3 md:h-[750px] lg:h-[1000px] xl:[1250px] box-max-width items-start justify-items-center'>
        ...
        <div className='flex md:hidden flex-col h-[550px] gap-12 max-width-[800px]'>
