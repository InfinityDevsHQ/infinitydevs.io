				...
				<div className="flex items-center justify-center">
					<div className="box-max-width mt-32 md:mt-20 lg:mt-28 3xl:mt-96 sm:mt-40 space-y-14">
						...
						<Button
							...
							className="mx-auto bg-blue-900/40 hover:-translate-y-1.5 transition-all ease-in-out duration-300 flex items-center gap-2 px-5 py-2 self-start common-border !rounded-full text-white"
						>
